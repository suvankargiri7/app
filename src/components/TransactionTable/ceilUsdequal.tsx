...
const CeilUsd: FunctionComponent<ceilUsdProps> = (props) => {
  ...
  useEffect(() => {
    const url = "https://anyapi.io/api/v1/exchange/convert?apiKey=ua4h13q2p49nekpgd4d8n87sc2lnhfoud77k29p2o5143tggj9ioe";
  ...
  return <Box display={"flex"}>${props.amount}</Box>;
};
